...
<html lang="ru">
  <head>
    ...
    <meta name="description" content="Демонтаж асбеста, промышленная изоляция, строительные леса, проектирование">
    <meta name="keywords" content="Демонтаж асбеста, промышленная изоляция, строительные леса, проектирование">
    <link rel="icon" href="images/tab.png">

    <title>FERARU Демонтаж асбеста, промышленная изоляция, строительные леса, проектирование</title>
...
================================================== -->
    ...
    <div class="navbar-wrapper">
      <div class="container">
        <nav class="navbar-inverse navbar-fixed-top">
          <div class="container"> 
            <a class="navbar-brand" href="#"><img id="logo" src="images/logo2.png" alt="Feraru"></a>
        ...
        <div class="item" id="fourth_slide">
          <div class="container">
            <div class="carousel-caption">
              ...
              <p>В сфере по удалению асбеста наши сотрудники используют самое современное оборудование.</p>
    ...
    <div class="container marketing">
      ...
      <div class="row featurette">
        ...
        <div class="col-md-5">
          <img class="featurette-image img-responsive center-block" src="images/serv1.jpg" alt="Промышленная изоляция">
        </div>
      </div>
      <!-- For Navigation -->
      ...
      <div class="row featurette">
        ...
        <div class="col-md-5 col-md-pull-7">
          <img class="featurette-image img-responsive center-block" src="images/serv2.jpg" alt="Строительные леса">
        </div>
      </div>
      <!-- For Navigation -->
      ...
      <div class="row featurette">
        ...
        <div class="col-md-5">
          <img class="featurette-image img-responsive center-block" src="images/serv3.jpg" alt="Проектирование">
        </div>
      </div>
      <!-- For Navigation -->
      ...
      <div class="row featurette">
        <div class="col-md-7 col-md-push-5">
          ...
          <p class="lead">Асбест – материал, который применяется в строительстве, на производстве и в других изоляционных работах.
          С асбестом следует обращаться осторожно, он может быть опасен, поскольку выпускает в воздух канцерогенные волокна, которые могут привести к раку.
          Наши сотрудники используют самое современное оборудование для работы в этой сложной сфере по удалению асбеста. Наша компания сделает работу чисто, быстро и качественно по всем предусмотренным правилам удалению асбеста.</p>
        </div>
        <div class="col-md-5 col-md-pull-7">
          <img class="featurette-image img-responsive center-block" src="images/serv4.jpg" alt="Демонтаж асбеста">
        </div>
      </div>
      <a name="about"></a>
      <hr class="featurette-divider">
